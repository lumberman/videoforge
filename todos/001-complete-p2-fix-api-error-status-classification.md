...
- [x] `POST /api/jobs` returns `400` only for invalid payloads
- [x] Internal write/read failures return `500`
- [x] Tests cover both validation and internal-failure paths
- [x] Existing success-path tests remain green
