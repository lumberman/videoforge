...
- [x] Fallback events produce observable logs/telemetry
- [x] Operators can distinguish mux-ai success vs fallback execution
- [x] No regression in deterministic behavior/tests
