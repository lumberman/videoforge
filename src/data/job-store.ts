...
export async function createJob(payload: JobCreatePayload): Promise<JobRecord> {
  ...
  const job: JobRecord = {
    ...
    sourceCollectionTitle: payload.sourceCollectionTitle,
    sourceMediaTitle: payload.sourceMediaTitle,
    requestedLanguageAbbreviations: payload.requestedLanguageAbbreviations,
